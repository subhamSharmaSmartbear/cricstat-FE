      ...
      >
        <div className="w-[100%] h-[15vh] mt-[1.5rem] rounded-[10px] bg-[#434343] flex justify-between">
          ...
          <div className="w-[55%] h-[100%]  flex justify-between  p-[1rem]">
            <div className="w-[20%] h-[100%]  flex flex-col items-center justify-start">
              <div className="w-[6rem] h-[5rem] ">
                <img src={mi} className="w-[100%] h-[100%]" alt="team"/>
              </div>
              <div className="flex text-white flex-col">
                <span className="text-[18px]">68/1</span>
                <span className="font-extralight">(5.5)</span>
              </div>
            </div>
            <div className="w-[55%] h-[100%]  text-white flex flex-col text-center justify-center">
              <span className="w-[100%] truncate">Mumbai indians need 118 runs in 65 balls</span>
              <span className="font-extralight text-[14px] truncate">Current RR : 11.65 | Required RR : 8.25</span>
            </div>
            <div className="w-[20%] h-[100%]  flex flex-col items-center justify-start">
              <div className="w-[6rem] h-[5rem] ">
